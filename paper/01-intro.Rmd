...
We can also include a picture as seen in figure \@ref(fig:fig1). it's a placeholder for now
...
\begin{gather}
  q_{j}=\frac{\sum_{i}b_{i}p_{i}}{\sum_{i}l_{i}p_{i}} (\#eq:some-eq)
\end{gather}

Data was collected from 365 children in August through October 2007 as part of cohort 1 of the MORE study, however only 362 of the study participants had addresses which were successfully geocoded @nelsen_introduction_2006.
