...
-lower (countermonotonic) bound:    

$W(\mathbf{u})=\max\{\sum_{j=1}^{d} u_j -d + 1, 0\}$ 

and upper (comonotonic) bound:
...
```{r tab1, eval=!knitr::is_html_output(), echo=FALSE, results='asis'}
...
* Dose-finding and optimal design
...
Bayesian adjusted R^2 for the meta-analytic evaluation of surrogate time-to-event endpoints in clinical trials [ref renfro]
